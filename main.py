...
def main():
    ...
    # enemy_spawn_timer = pygame.time.get_ticks() + 3000  # extra delay (9seconds)
    ...
    while player_alive:
        ...
        #     enemy = Enemy(10, random.randrange(40, 300), -200);  # type, x (offscreen), y account for terrain
        #     enemy_list.add(enemy)
        #     # Enemy fire laser
        ...
        #         # Initialize a new laser, and add it to the group
        #         laser = Lasers(enemy_ship.rect.x + 11, enemy_ship.rect.y, False, 0, False)
        #         laser_list.add(laser)
        #     # Player touch enemy
